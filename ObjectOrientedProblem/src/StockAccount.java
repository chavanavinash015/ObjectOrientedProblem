...
public class StockAccount {
	...
	class NewStock implements IStockAccount {
		...
		public static void main(String[] args) {
			...
			int totalValue = stock.setTotalValue(stockName);
			System.out.println("The tatal value stock for company" + totalValue);
		}
	}

	public int setTotalValue(int i) {
		return this.setTotalValue(i);
	}

	public int setTotalValue(String stockName) {
		return 0;
	}
	...
	public void addDetails(String string, int i, int j) {
